...
const SCHOOL_SCHEMA = "public"; // Modified from "school" to "public" based on your migrations
...
Deno.serve(async (req: Request) => {
  try {
    const dispatchSecret = requireEnv("DISPATCH_SECRET", Deno.env.get("DISPATCH_SECRET"));
