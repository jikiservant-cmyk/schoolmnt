...
import { Cpu, Wifi, WifiOff, Clock, Activity } from 'lucide-react';
      ...
      {devices.map((dev) => {
        ...
        return (
          <div
            ...
            className={`p-5 rounded-xl border transition duration-200 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 ${
              isOnline
